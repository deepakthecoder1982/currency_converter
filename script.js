...
document.querySelector("#fromCountry").addEventListener("change", (e)=>{
    ...
    image.setAttribute("src", `https://www.countryflagicons.com/FLAT/64/${value}.png`||`https://www.countryflagicons.com/FLAT/64/US.png`);

})
document.querySelector("#toCountry").addEventListener("change", (e)=>{
    const {value} = e.target;
    let image = document.querySelector(".converter .to_converter img");
    image.setAttribute("src", `https://www.countryflagicons.com/FLAT/64/${value}.png`);
...
document.querySelector(".switchingArrow").addEventListener("click",async()=>{
